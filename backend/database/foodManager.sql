...
-- Supermercado SQL Schema
-- Compatible con MariaDB 10.4+ / MySQL 8+
-- Este script crea un esquema para un supermercado con gestión de inventario,
-- compras (ordenes de compra), ventas (POS), productos, categorías, proveedores,
-- almacenes/ubicaciones, usuarios y roles (admin/usuario).
